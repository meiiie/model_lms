...
| 12 | **Modern Bridge Cockpit** | ✅ v1.3 corrected texture mapping + geometry detail | ~32,000 | 0 | [`12_Modern_Bridge_Cockpit/`](./12_Modern_Bridge_Cockpit/) |
...
| Modern Bridge Cockpit | ✅ v1.3 corrected texture mapping candidate | ~32,000 | 31+ | 0 |
...
✅ **Format Coverage:**
- 24 GLB exports (modern, web-ready, requires `com.unity.cloud.gltfast` package in Unity)
- 19 FBX exports (Unity native, plug-and-play, no extra package needed)
...
| 12 Modern Bridge Cockpit | ✅ **6.19 MB** | ✅ **6.62 MB** | v1.3 procedural geometry with screen textures only, stable PBR materials on structural/contact meshes, anchors, and collision proxies |
